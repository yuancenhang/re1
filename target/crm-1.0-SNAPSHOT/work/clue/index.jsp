...
<script type="text/javascript">
	...
	//封装的刷新市场活动列表的方法,分页显示
	function loadClueList(pageNo,pageSize){
		//把数据从隐藏域中取出来，
		var fullname = $.trim($("#search-surname").val());
		...
		var state = $.trim($("#search-status").val());
		//填在查询框中
		$("#search-surname").val(fullname);
		$("#search-company").val(company);
		$("#search-phone").val(phone);
		$("#search-source").val(source);
		$("#search-owner").val(owner);
		$("#search-mphone").val(mphone);
		$("#search-status").val(state);
		$.ajax({
			url:"work/clue/getClueList.sv",
			type:"post",
			dataType: "json",
			data:{
				"pageNo":pageNo,
			...
			success:function (data){
				...
				$.each(data.list,function (i,n) {
					...
					html += '<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href=\'work/clue/selectById.sv?id='+n.id+'\';">'+n.fullname+'</a></td>';
				...
				$("#loadPage").bs_pagination({
					...
					onChangePage:function (event,data){
						loadClueList(data.currentPage,data.rowsPerPage);
					}
				})
			}
		})
...
<body>
	<input type="hidden" id="search-surname">
	<input type="hidden" id="search-company">
	<input type="hidden" id="search-phone">
	<input type="hidden" id="search-source">
	<input type="hidden" id="search-owner">
	<input type="hidden" id="search-mphone">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<select class="form-control" id="create-call">
									<!--items是被遍历的对象，是一个List。   var是每次遍历得到的元素-->
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<select class="form-control" id="create-status">
								  <c:forEach items="${clueStateList}" var="sta">
