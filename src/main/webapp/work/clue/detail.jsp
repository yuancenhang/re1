...
<script type="text/javascript">
	...
	$(function(){
		...
		//关联线索与活动按钮被单击(保存联系)
		$("#guanlianSaveBtn").click(function () {
			saveguanlian();
		})
		//动态创建出来的checkbox被点击,全选功能
		$("#ActivityBody").on("click",".box",function () {
			$("#allBox").prop("checked",$(".box").length==$(".box:checked").length);
		})
		//全选的checkbox被点击,全选功能
		...
		<div class="modal-dialog" role="document" style="width: 80%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" id="guanlianSaveBtn">关联</button>
				</div>
			</div>
		</div>
	</div>
