...
(function(e){
    ...
    var f=function(F,k,g,J,u){
                    ...
                    if(u){
                                            I.triggerHandler("onChangePage",{
                                                currentPage:g,rowsPerPage:B.rowsPerPage}
                                            )}
                    else{
    ...
    e.fn.bs_pagination=function(h){
                                                        if(1!=this.size){
                                                            ...
                                                            this.html('<span style="color: red;' +
                                                                '">ERROR: '+g+"</span>");
                                                            e.error(g)}
                                                        if(b[h]){
